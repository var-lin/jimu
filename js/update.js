$(function () {
    ...
    var version = '2023.05.20.999',
        sourceCodeUrl = 'https://var-lin.github.io/jimu/download/积木' + version + '版本源码.zip',
        androidUrl = 'https://var-lin.github.io/jimu/download/积木_' + version + '.apk';
    ...
    // 判断最新版本
    axios.get('https://var-lin.github.io/jimu/update.json').then((res) => {
        res = res.data;
        function showUpdate() {
        ...
        var updateAndroidUrl = 'https://var-lin.github.io/jimu/download/积木_' + res.updateV + '.apk';
